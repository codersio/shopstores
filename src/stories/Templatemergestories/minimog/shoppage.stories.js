import Shopdpage from "../../../components/Tmplatefilemerge/Minimog/shoppage";

export default {
  title: "allshoppages/Shopdpage",
  component: Shopdpage,
};

const Template = (args) => <Shopdpage {...args} />;

export const Shoppages = Template.bind({});
Shoppages.args = {
  minimog: {
    mainmenu: [
      {
