  ...
  return (
    <div className="register-container grid place-items-center   p-8">
      <div className="p-8 w-[50%]  register-left-row text-[#333e48] font-Poppins space-y-4">
        <h3 className="text-[#212222] text-[16px] font-[600] uppercase">
          signin
        </h3>
        <hr />
        ...
        <div className="fomr space-y-4">
          ...
          <div className="for font-Poppins">
            <div className="item  text-[14px]">
              <div className="icon flex space-x-3 text-[11px]">
                <div>
                  <FontAwesomeIcon icon={faEnvelope} className=" text-[14px]" />
                </div>
                <h3 className="text-[#bbb]">
                  Forgot your <span className="text-[#6aa1da]">Password</span> ?
                </h3>
              </div>
              <h3 className="text-[#666] text-[12px]">
                If you have an account, please{" "}
                <span onClick={() => setTabs(1)} className="text-[#6aa1da]">
                  Register Here
                </span>
              </h3>
            </div>
